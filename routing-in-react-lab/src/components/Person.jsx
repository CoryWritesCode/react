      ...
      <Fragment>
        <div className="card text-white bg-dark" style={{ innerWidth: '18rem', margin: '20px' }} >
          <div className="card-body">
            ...
            <h6 className="card-subtitle mb-2 text-danger">Eye Color: { this.state.card.eye_colors }</h6>
            <h6 className="card-subtitle mb-2 text-danger">Hair Color: { this.state.card.hair_colors }</h6>
